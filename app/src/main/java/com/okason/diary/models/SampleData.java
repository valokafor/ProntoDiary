...
public class SampleData {
    ...
    public static List<Note> getSampleNotes() {
        ...
        Note note1 = new Note();
        note1.setTitle("Sample Journal with Image");
        ...
        Note note2 = new Note();
        note2.setTitle("Sample Journal with Video");
        note2.setContent("I went to the Gym today and I got a lot of exercises. Please delete this sample journal entry");
        ...
        //create the dummy note
        Note note3 = new Note();
        note3.setTitle("Sample Journal with Multiple Images");
        note3.setContent("I will like to write a blog post about how to make money online. Please delete this sample journal entry");
        ...
        note3.getAttachments().add(attachment6);
        ...
        note3.getAttachments().add(attachment7);
        notes.add(note3);


        //create the dummy note
        Note note4 = new Note();
        note4.setTitle("Sample Journal with File Attachment");
        note4.setContent("Today I found a recipe to make cup cake from www.google. Please delete this sample journal entry");

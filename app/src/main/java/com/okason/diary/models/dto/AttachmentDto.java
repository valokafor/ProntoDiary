...
public class AttachmentDto {
    ...
    public AttachmentDto(Uri uri, String imagePath, String mime_type) {
    ...
    public AttachmentDto(Uri uri, String imagePath, String mime_type, String name) {
        this.uri = uri.toString();
        this.localFilePath = imagePath;
        this.mime_type = mime_type;
        this.name = name;
    ...
    public AttachmentDto(String ext){
        mime_type = ext;
    }

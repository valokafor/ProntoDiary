...
public class SampleData {
    ...
    public static void getSampleNotes() {
            ...
            attachment1.setLocalFilePath("https://wallpaperscraft.com/image/car_trees_rear_view_115473_602x339.jpg");
            attachment1.setMime_type(Constants.MIME_TYPE_IMAGE);
            note1.getAttachments().add(attachment1);

            Attachment attachment2 = new Attachment();
            attachment2.setLocalFilePath("https://wallpaperscraft.com/image/aston_martin_dbs_2008_gray_rear_view_car_house_trees_27721_602x339.jpg");
            attachment2.setMime_type(Constants.MIME_TYPE_IMAGE);
            note1.getAttachments().add(attachment2);

            Attachment attachment3 = new Attachment();
            attachment3.setLocalFilePath("http://images.all-free-download.com/images/graphicthumb/tree_meadow_nature_220408.jpg");
            attachment3.setMime_type(Constants.MIME_TYPE_IMAGE);
            note1.getAttachments().add(attachment3);

            Attachment attachment4 = new Attachment();
            attachment4.setLocalFilePath("https://static.pexels.com/photos/132982/pexels-photo-132982.jpeg");
            ...
            attachment5.setLocalFilePath("https://i1.wallpaperscraft.com/image/cups_tea_drink_tea_115303_300x188.jpg");

 ...
 */
public class DownloadFileFromFireaseIntentService extends IntentService {
    ...
    public DownloadFileFromFireaseIntentService() {
        super("DownloadFileFromFireaseIntentService");
    }
